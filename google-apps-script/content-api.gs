...
function copyRows() {
  return [
    ...
    ['home.projectVariants.0.visible', 'TRUE', '[홈] 프로젝트 이미지 항목 1 표시 여부'],
    ...
    ['home.projectVariants.1.visible', 'TRUE', '[홈] 프로젝트 이미지 항목 2 표시 여부'],
    ...
    ['home.projectVariants.2.visible', 'TRUE', '[홈] 프로젝트 이미지 항목 3 표시 여부'],
